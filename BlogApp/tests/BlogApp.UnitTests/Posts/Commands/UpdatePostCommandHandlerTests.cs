...
public class UpdatePostCommandHandlerTests : TestCommandBase
{
    ...
    public async Task UpdatePostCommandHandler_Success()
    {
        ...
        var newText = "Vestibulum ante ipsum primis in faucibus orci luctus.";
        var newHeader = "Sed vel molestie lectus. Suspendisse posuere sodales nibh.";
        ...
        //Assert
        (await Context.Posts.SingleOrDefaultAsync(c =>
                c.Id == BlogAppContextFactory.ToBeUpdatedPostId && c.Text == newText && c.Header == newHeader)).Should()
            .NotBeNull();
    }
